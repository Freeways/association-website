 ...
 */
?>
<div class="vud-widget vud-widget-upanddown well well-small" id="<?php print $id; ?>">
  <div class="up-score clear-block">
    <?php if ($show_links): ?>
      ...
      <?php endif; ?>
    <?php endif; ?>
    <span class="up-current-score label label-success"><?php print $up_points; ?></span>
  </div>
  ...
  <div class="down-score clear-block">
    <?php if ($show_links): ?>
      ...
      <?php endif; ?>
    <?php endif; ?>
    <span class="down-current-score label label-default"><?php print $down_points; ?></span>
  </div>
  <?php if ($show_reset): ?>
